...
quick-rules와 동일한 --check 게이트 + 73패턴 전수 커버 + 빈 항목 0 +
부피 상한을 여기서 고정한다.
...
# 한글 UTF-8 3바이트 특성상 73패턴 × 2줄의 물리 하한이 있어 상한 14KB.
MAX_BYTES = 14 * 1024
...
class DiagnosisRulesBuildTests(unittest.TestCase):
    ...
    def test_all_73_ids_covered(self) -> None:
