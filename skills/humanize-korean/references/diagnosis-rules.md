...
- **A-25** [S1] 행위자 소거 명사 압축 — 누가 했는지 지우고 "명사 + 미/무 + 술어명사"로 눌러 담는다.…
  시그니처: 행위자 없는 "N 미제공/미제출/확인되지 않음" 명사 압축 · 예: "KGS 문서 당사 미제공"(누가 누구에게?)
...
- **E-8** [S2] 문서 유형과 종결 방식 불일치
  시그니처: 사내 보고·검토 자료·회의 자료에 "~습니다" 서술체를 끝까지 유지한다.…
...
- **F-6** [S1] 실무 미사용 한자 조어 — 사전에는 있으나 실무 문서에서 쓰지 않는 한자 조어를 격식으로 착각…
  시그니처: 실무 용례 없는 한자 조어(무연동·겸유·부존재·금원·기수령·대응 급부) · 예: "손실액과 무연동
- **F-7** [S2] 범용 정책동사 수렴 (확대·강화·개선 + 만능 "설계") — 행위 서술 자리마다 소수의 범용 한자어 동사로 수렴 — 확대·강화·…
  시그니처: 범용 정책동사(확대·강화·개선·확보·마련·구축 등) 문서 밀집 + 추상 목…
- **F-8** [S2] 부정 접두사 명사 압축 남발
  시그니처: "미-"·"불-"·"무-"를 명사 앞에 붙여 서술을 없앤 형태가 한 문단에…
