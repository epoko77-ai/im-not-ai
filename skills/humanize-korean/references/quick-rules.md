...
- **A-25** 행위자 없는 "N 미제공/미제출/확인되지 않음" 명사 압축 → 행위자를 주어로 세워 동사로 환원("당사 미제공" → "ALK가 당사에 준 적 없음"). 행위자 특정 불가 시 보존
...
- **F-6** 실무 용례 없는 한자 조어(무연동·겸유·부존재·금원·기수령·대응 급부) → 실무 통용어로 환원("무연동" → "무관", "부존재" → "없음"). 법령-계약 인용부와 확립된 법률 용어는 보존
