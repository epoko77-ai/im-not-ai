...
- 이 스킬의 치환표는 `.claude/skills/humanize-korean/references/ai-tell-taxonomy.md`의 A-7(light verb construction)·F-4(한자어 명사화 -성/-적/-화) 처방을 커밋 메시지 register로 특화한 파생본이다. taxonomy가 갱신되면 `references/commit-lexicon.md`도 함께 점검할 것.
