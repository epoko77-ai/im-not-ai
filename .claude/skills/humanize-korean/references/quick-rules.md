...
- **C-8** "A인가, B인가"·"A가 아니라 B" 대구 3회+ 반복 — 또는 은유(비유어 대립축)·한자/영어 병기와 겹치면 1회라도 → 한 번만 살리고 나머지는 비대칭 평서문·직접 단언으로; 은유·병기가 얹혔으면 병기 제거에 그치지 말고 비유어(점/선 등)를 지시 대상으로 치환해 은유 축까지 해체(대구 안에서만)
