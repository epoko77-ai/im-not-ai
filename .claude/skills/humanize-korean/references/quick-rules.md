...
- **A-21** 매개 명사 없이 추상 명사에 오르다/서다/위/앞 공간 술어 결합 → 되다/이르다/못 미친다 판정 서술로 환원, 굳은 관용구는 보존
...
- **C-8** "A인가, B인가"·"A가 아니라 B" 대구 3회+ 반복, 전제 없는 허수아비 대조는 1회도 → 한 번만 살리고 나머지는 비대칭 평서문·직접 단언으로, 허수아비 A절은 삭제 후 직진
