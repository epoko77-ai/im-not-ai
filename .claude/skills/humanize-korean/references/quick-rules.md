...
**Do-NOT (탐지·윤문 모두 제외):** 고유명사·제품명·모델명·기관명, 수치·날짜·단위, 큰따옴표 안 직접 인용, 법률 조문, 수학·화학·통계 표기, 영어 약어(LLM·GPU·MCP·API 등 업계 표준). · **의학·법률·정책 텍스트의 헤지 강도**("~할 수 있다"·"~로 보인다" — A-10·G-2 처방 미적용, 2026-09-22)
...
| A-10 | "~할 수 있다" 남발 | S2 | 단언으로("높일 수 있다" → "높인다") — ⚠️의학·법률·정책 텍스트는 미적용(헤지=의미, 강도 유지·형태만 변주) |
...
| G-2 | "~로 보인다/~인 듯하다" 추정 남발 | S2 | 단언 가능한 곳은 단언 — ⚠️의학·법률·정책 텍스트는 미적용(헤지=의미) |
