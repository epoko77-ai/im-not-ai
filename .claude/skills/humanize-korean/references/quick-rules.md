...
- **G-1** 추측 종결 "~로 보인다/~로 판단된다/~라고 여겨진다/~인 듯하다" 남발 → 단언 가능한 곳은 단언 — 단 부정·이중부정 문장은 긍/부정 극성 유지 확인, 애매하면 원문 보존
- **G-2** 이중-삼중 완곡 "~할 가능성이 있을 수 있다/~로 보여질 수 있다" → 완곡 하나만 남김 — 남긴 완곡은 원문 극성·확신도 유지, 부정 낀 중첩과 협상문은 원문 보존
