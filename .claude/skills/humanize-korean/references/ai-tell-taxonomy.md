...
- **은유·병기 공출현 예외 — 1회라도 발동 (2026-07 실전 보강)**: 「A가 아니라 B」 대구가 ①대립 은유(점/선, 도구/무기, 씨앗/열매처럼 비유어를 A·B 축에 얹음) 또는 ②한자병기(點·線)·영어병기와 **같은 문장에서 겹치면**, 3회 반복 임계를 못 채워도(=1회라도) 발동한다. 근거: 담백한 대구 1회는 사람도 흔히 쓰므로 단독으로는 3회 임계를 유지하되(오검출 방지), 은유를 대립축에 얹고 거기에 한자/영어까지 병기하는 **조합**은 인간 실무 산문에 거의 없는 AI 시그니처다 — finalizer가 이 쉼표를 "정당한 호흡"으로 무죄 처리한 실사고(2026-07)가 근거.
- **처방은 2단계 — 병기 제거만으로 끝내지 말 것**: ①한자·영어 병기를 먼저 벗기고, ②**비유어(점/선 등)까지 그 지시 대상으로 치환해 은유 축 자체를 해체**한다. 한자만 벗기고 '점/선'을 남기면 미완이다(2026-07 재현: 병기는 빠졌으나 점/선 은유가 잔존해 여전히 번역투로 읽힘). 단 이 강화는 **부정대구+은유 공출현 안에서만** 적용 — 대구 없이 홀로 선 저자 비유는 철칙 #4(과윤문 금지)에 따라 보존한다. 예: "AI를 자동완성처럼 점(點)으로 쓰는 것이 아니라 …선(線)으로 잇는 것" → "AI를 여기저기 단발로 갖다 쓰는 게 아니라 …요구사항부터 배포까지 전 구간에 이어붙이는 것"(점→단발, 선→이어붙임으로 지시 대상 치환).
- 처방: 3개 중 2개는 비대칭으로 재배치. 한쪽만 질문형·다른 쪽은 서술형으로 섞거나, 한쪽을 더 길게 풀어쓰고 다른 쪽은 짧게.
- _quick: true · quick_pattern: "A인가, B인가"·"A가 아니라 B" 대구 3회+ 반복 — 또는 은유(비유어 대립축)·한자/영어 병기와 겹치면 1회라도 · quick_fix: 한 번만 살리고 나머지는 비대칭 평서문·직접 단언으로; 은유·병기가 얹혔으면 병기 제거에 그치지 말고 비유어(점/선 등)를 지시 대상으로 치환해 은유 축까지 해체(대구 안에서만)_
