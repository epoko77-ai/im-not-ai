...
- "~라고 여겨진다"
- "~인 듯하다"가 모든 문장 끝에 붙음
- 처방: 단언할 수 있는 곳은 단언. hedging은 정말 불확실한 지점에만. **극성 가드**: 부정·이중부정("~되지 않을 수 있다는 걱정")을 줄여 쓰면 긍/부정이 뒤집히기 쉽다("~되지 않을까"는 기대 표현으로 읽힘 — 2026-08-15 실사고). 부정이 낀 문장은 극성 확인 후 손대고, 애매하면 원문 보존.
- _quick: true · quick_pattern: 추측 종결 "~로 보인다/~로 판단된다/~라고 여겨진다/~인 듯하다" 남발 · quick_fix: 단언 가능한 곳은 단언 — 단 부정·이중부정 문장은 긍/부정 극성 유지 확인, 애매하면 원문 보존_

### G-2. 이중·삼중 완곡
- "~할 가능성이 있을 수 있다"
- "~로 보여질 수 있다"
- 처방: 하나만 남김. **극성·확신도 가드**: 남기는 완곡은 원문과 같은 극성·확신도여야 한다. 부정이 낀 완곡 중첩을 접으면 의미가 뒤집히거나 주장이 단언으로 승격된다 — 협상·이해관계 문서(이메일·계약 회신)에서는 완곡 중첩이 입장 강도 그 자체이므로 접지 말고 원문 보존.
- _quick: true · quick_pattern: 이중-삼중 완곡 "~할 가능성이 있을 수 있다/~로 보여질 수 있다" · quick_fix: 완곡 하나만 남김 — 남긴 완곡은 원문 극성·확신도 유지, 부정 낀 중첩과 협상문은 원문 보존_
